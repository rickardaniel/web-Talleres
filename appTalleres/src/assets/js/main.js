function cerrarModal(string) {
    ...
    $(function() {
        ...
        $(string).modal("hide");
        // $('.main-panel').removeClass('modal-open');
...
function abrirSegundoModal() {
    $(document).on('click', '#segundoModal', function() {
...
function botonNav() {
    ...
    botonSidebarLeft.addEventListener('click', function() {
        ...
        // botonSidebarLeft1.addEventListener('click', function() {
        //     html.classList.toggle('nav-open');
...
function mostrarForm() {
    $(document).ready(function() {
        $("#btnEmpresa").click(function() {
            $("#formAccesoTalleres").toggle();
            // const btn = document.getElementById('btnEmpresa');
            $('#formRUC').hide();
            $('#btnEmpresa').hide(); //oculto mediante id
        });
    });
}
...
function print(e, t) {
    ...
    return function(e) {
        ...
        function p(e) {
            if (e.showModal && a.close(), e.onLoadingEnd && e.onLoadingEnd(), (e.showModal || e.onLoadingStart) && window.URL.revokeObjectURL(e.printable), e.onPrintDialogClose) {
                var t = "mouseover";
        ...
        var y = function(e, t) {
            ...
            n ? (e.printableElement = function r(e, t) {
                ...
                t.scanStyles && 1 === e.nodeType && n.setAttribute("style", function(e, t) {
                    ...
                    return n + "max-width: " + t.maxWidth + "px !important;" + t.font_size + " !important;"
                }(e, t));
                switch (e.tagName) {
                    case "SELECT":
                        n.value = e.value;
        ...
        var S = ["pdf", "html", "image", "json", "raw-html"],
            x = function() {
                ...
                switch (o.isFirefox() ? i.setAttribute("style", "width: 1px; height: 100px; position: fixed; left: 0; top: 0; opacity: 0; border-width: 0; margin: 0; padding: 0") : i.setAttribute("style", "visibility: hidden; height: 0; width: 0; position: absolute; border: 0"), i.setAttribute("id", e.frameId), "pdf" !== e.type && (i.srcdoc = "<html><head><title>" + e.documentTitle + "</title>", e.css && (Array.isArray(e.css) || (e.css = [e.css]), e.css.forEach((function(e) {
                    ...
                    case "pdf":
                        if (o.isIE()) try {
                            if (console.info("PrintJS currently doesn't support PDF printing in Internet Explorer."), !0 === e.onBrowserIncompatible()) {
                                var l = window.open(e.fallbackPrintable, "_blank");
                                l.focus(), e.onPdfOpen && e.onPdfOpen()
                            }
                        } catch (d) {
                            e.onError(d)
                        } finally {
