...
@Component({
  selector: 'app-prioridad-mantenimiento',
  templateUrl: './prioridad-mantenimiento.component.html',
  styleUrls: ['./prioridad-mantenimiento.component.scss']
})
export class PrioridadMantenimientoComponent implements OnInit {
